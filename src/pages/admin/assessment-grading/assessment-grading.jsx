...
const parameterFields=[
    ...
    {name:"assessment_score", label:"Assessment score", type:"number", placeholder:"Input  assessment score", required:true},
    {name:"assessment_score",
         label:"Assessment score",
          type:"select",
           placeholder:"Input  assessment score",
            required:true,
            options:[
                {name:"A", value:"a"},
                {name:"B", value:"B"},
    ...
    {name:"remarks", label:"Remarks", type:"textarea", placeholder:"Input remarks", required:false},
        ...
        <Container>
            ...
            <Content className="main-content">
                ...
                <ContentBottom>
                    <ParameterUtilities>
                    <UtilitiesLeft>
                        <ContentTitle>Assessment Grading</ContentTitle>
                    <p>Manage assessment  grading records </p>
