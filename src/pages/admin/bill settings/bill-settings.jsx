...
`
const tableHeadings=[
    {name:"Bill Type", selector:"bill_type"},
    {name:"Description", selector:"description"},
    {name:"Status", selector:"status"},
    {name:"Action", selector:"status"},
]
const parameterFields=[
    {name:"bill_type", label:"Bill Type", placeholder:"Input  bill type", required:true},
    {name:"description", label:"Description", type:"textarea", placeholder:"Input description", required:true},
        ...
        <Container>
            ...
            <Content className="main-content">
                ...
                <ContentBottom>
                    <ParameterUtilities>
                    <UtilitiesLeft>
                        <ContentTitle>Bill Setting</ContentTitle>
                    <p>Manage bill setting records </p>
