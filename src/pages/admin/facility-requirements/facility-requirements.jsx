...
`
const tableHeadings=[
    {name:"Facility Type", selector:"facility_type"},
    {name:"Requirement name", selector:"requirement_name"},
...
const parameterFields=[
    ...
    {name:"facility_requirement_name", label:"Facility Requirement Name",  placeholder:"Requirement Name", required:true},
...
const FacilityRequirementParameterPage=()=>{
        ...
        <Container>
            ...
            <Content className="main-content">
                ...
                <ContentBottom>
                    <ParameterUtilities>
                    <UtilitiesLeft>
                        <ContentTitle>Facility Requirement</ContentTitle>
                    <p>Manage facility Requirement records </p>
...
export default FacilityRequirementParameterPage ;