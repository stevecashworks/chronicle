...
`
const tableHeadings=[
    // {name:"Qualification Code", selector:"qualification_code"},
    {name:"Qualification Name", selector:"qualification_name"},
    {name:"Description", selector:"description"},
    // {name:"Status", selector:"status"},
    {name:"Action", selector:"status"},
]
const parameterFields=[
    {name:"name", label:"Qualification name", placeholder:"Input qualification name", required:true},
    {name:"description", label:"Description", type:"textarea", placeholder:"Input description", required:false},
  
]
const StateParameterPage=()=>{
        ...
        <Container>
            ...
            <Content className="main-content">
                ...
                <ContentBottom>
                    <ParameterUtilities>
                    <UtilitiesLeft>
                        <ContentTitle>Qualification</ContentTitle>
                    <p>Manage qualification records </p>
...
export default StateParameterPage