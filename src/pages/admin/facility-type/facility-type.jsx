...
`
const tableHeadings=[
    {name:"Facility Type Name", selector:"facility_type_name"},
    {name:"Description", selector:"description"},
    {name:"Status", selector:"status"},
    {name:"Action", selector:"status"},
]
const parameterFields=[
    {name:"name", label:"Facility Type Name", placeholder:"Input facility type name", required:true},
...
const FacilityTypeParameterPage=()=>{
        ...
        <Container>
            ...
            <Content className="main-content">
                ...
                <ContentBottom>
                    <ParameterUtilities>
                    <UtilitiesLeft>
                        <ContentTitle>Facility Type</ContentTitle>
                    <p>Manage facility type records </p>
...
export default FacilityTypeParameterPage ;